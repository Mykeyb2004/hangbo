...
**Goal:** Produce a Q1 observation PPT where numeric tables use 14pt text, Chinese labels use KaiTi, numeric values use Times New Roman, and default table regions are slightly taller.
...
- [ ] Add tests proving table defaults use 14pt and the slightly taller layout.
...
- [ ] Add table font constants for `楷体`, `Times New Roman`, and `14.0`.
- [ ] Update default PPT table font sizes to `14.0`.
